      ...
      <div className="hidden lg:flex flex-col justify-between bg-accent text-bg-primary p-12">
        ...
        <div className="max-w-md">
          <h2 className="text-3xl font-semibold leading-tight mb-4">
            Auto-reply to your Google reviews in your own voice.
          </h2>
          <p className="text-base leading-relaxed opacity-70">
            ...
            one click. It&apos;s like having a front-desk person who never
            forgets to say &ldquo;thank you.&rdquo;
          </p>
        </div>

        <div className="flex gap-6 text-sm opacity-50">
          <span>Free for up to 10 reviews/month</span>
          <span>·</span>
